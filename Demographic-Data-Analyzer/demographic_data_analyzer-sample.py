...
def calculate_demographic_data(print_data=True):
    ...
    country_earn_over_50k = df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()
    highest_earning_country = country_earn_over_50k.idxmax()
    highest_earning_country_percentage = country_earn_over_50k.max() * 100
